...
const SubscriptionCard = ({ planName, price, duration, features, buttonText, isActive }) => {
    return (
        <div
            className={`w-full max-w-sm p-6 rounded-xl border-2 ${isActive ? "border-blue-400 bg-primarySolid text-white" : "border-gray-400 bg-[#01183A] text-white"
        ...
        >
            ...
            <button
                className={`w-full py-2 rounded-full font-semibold flex items-center justify-center gap-2 ${isActive ? "bg-black hover:bg-gray-800" : "bg-blue-600 hover:bg-blue-500"
                    } transition-all`}
            >
                {buttonText}
