        ...
        <header className="sticky top-0 z-40 bg-[#001745] text-white shadow-lg">
                ...
                <nav className="hidden lg:flex lg:space-x-4 lg:justify-center">
                    {[
                        ...
                        <NavLink
                            ...
                            to={to}
                            className={({ isActive }) =>
                                `px-4 py-2 rounded-full transition ${isActive ? "bg-blue-800 text-white" : "hover:bg-blue-700 hover:text-white"}`
                            }
                        >
                            {label}
                        </NavLink>
            ...
            <div className={`fixed top-0 left-0 h-full w-64 bg-[#001745] text-white z-50 shadow-lg transform ${menuOpen ? "translate-x-0" : "-translate-x-full"} transition-transform duration-300`}>
                <div className="flex items-center justify-between p-4 border-b border-gray-700">
                    ...
                    <button onClick={toggleMenu} className="text-white bord focus:outline-none">
                        ...
                        {[
                            ...
                            <li key={to}>
                                <NavLink
                                    to={to}
                                    className={({ isActive }) =>
                                        `block px-4 py-2 rounded-md transition ${isActive ? "bg-blue-800 text-white" : "hover:bg-blue-700 hover:text-white"}`
                                    }
                                    onClick={toggleMenu}
                                >
                                    {label}
