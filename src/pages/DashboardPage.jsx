...
const DashboardPage = () => {
  ...
  // const hiddenRoutes = ["/subscription", "/dashboard/setting", "/dashboard/account-setting", "/dashboard/player-team-favorites"];
  // Hide EventsBar if the path includes "/subscription"

  const shouldHideEventsBar =
    location.pathname.includes("/subscription") ||
    [
      "/dashboard/setting",
      "/dashboard/account-setting",
      "/dashboard/player-team-favorites",
