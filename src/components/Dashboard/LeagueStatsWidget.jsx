        ...
        >
            <div className={`transition-opacity duration-500 ${fade ? "opacity-100" : "opacity-0"}`}>
                ...
                <div className="flex flex-col justify-center w-full text-sm font-bold tracking-tight">
                    {/* <p>League Name:</p> */}
                    <h3 className="self-stretch text-lg text-center text-white my-auto">{league?.leagueName}</h3>
                                ...
                                {isSoccer ? (
                                    <div className="pb-3 text-sm flex w-full justify-between">
                                        <div className="mr-5 font-semibold tracking-normal text-gray-400">
                                            <p className="text-sm text-center font-semibold text-green-500">Rank</p>
                                            <p className="text-sm text-center">{topTeam?.rank || "-"}</p>
                                        </div>
                                        <div className="mr-5 font-semibold tracking-normal text-gray-400">
                                            <p className="text-sm text-center font-semibold text-green-500">Points</p>
                                            <p className="text-sm text-center">{topTeam?.points || "-"}</p>
                                        </div>
                                        <div className="font-semibold tracking-normal text-gray-400">
                                            <p className="text-sm text-center font-semibold text-yellow-500">Goals Diff</p>
                                    ...
                                    <div className="pb-3 text-sm flex w-full justify-between">
                                        <div className="mr-5 font-semibold tracking-normal text-gray-400">
                                            <p className="text-sm text-center font-semibold text-red-500">Wins</p>
                                            <p className="text-sm text-center">{topTeam?.won || "-"}</p>
                                        </div>
                                        <div className="mr-5 font-semibold tracking-normal text-gray-400">
                                            <p className="text-sm text-center font-semibold text-green-500">Losses</p>
                                            <p className="text-sm text-center">{topTeam?.lost || "-"}</p>
                                        </div>
                                        <div className="mr-5 font-semibold tracking-normal text-gray-400">
                                            <p className="text-sm text-center font-semibold text-yellow-500">Points.Diff</p>
                                            <p className="text-sm text-center">{topTeam?.points?.difference || "-"}</p>
                                        </div>
                                    </div>
                                )}
                            </div>
