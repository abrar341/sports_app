  ...
  return (
    <Routes>
      ...
      >
        ...
        <Route
          path="/games-insight/:gameType/:leagueId/:status/:fixtureId"
          element={<GameDetails />}
        >
        ...
        <Route
          path="/subscription/success/:subcribtionPlan"
          element={<Success />}
        />
        <Route path="/subscription/cancel/:sessionId" element={<Cancel />} />
        {/* <Route path="/betting-odds" element={<BettingOdds />} /> */}
        <Route
          path="/dashboard/player-team-favorites"
          element={<PlayerTeamFavourites />}
        />
