...
const TeamInsight = () => {
  const { selectedTeam, selectedTeamStats } = useSelector(
    (state) => state.selection
  );
  const { favoriteTeamsOfSelectedTeamSport } = useSelector(
      ...
      <div className=" grid  grid-cols-12 gap-3 md:gap-6">
        ...
        {selectedTeam && (
          <>
            <div className="col-span-12">
              <TeamCard
                selectedTeam={normalizeSelectedTeamData(
                  selectedTeam,
                  selectedTeamSports
                )}
            ...
            {selectedTeamStats.length > 0 && (
              <>
                ...
                <div className="col-span-12 lg:col-span-4">
                  <TeamsPieChart data={selectedTeamStats} />{" "}
                  {/* Pass TeamPieChartData as prop */}
                </div>
              </>
            )}
          </>
